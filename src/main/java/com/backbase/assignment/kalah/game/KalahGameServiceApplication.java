package com.backbase.assignment.kalah.game;
...
import com.backbase.assignment.kalah.game.util.AppProfiles;
...
public class KalahGameServiceApplication {
	private static final Logger log = LoggerFactory.getLogger(KalahGameServiceApplication.class);
	private static final String SPRING_PROFILE_DEFAULT = "spring.profiles.default";

	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(KalahGameServiceApplication.class);
